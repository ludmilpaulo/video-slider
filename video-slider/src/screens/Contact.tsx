  ...
  return (
    <div className="flex flex-col w-full min-h-screen overflow-x-hidden bg-black">
      ...
      >
        ...
        <label className="text-zinc-900 lg:text-[285px] md:text-zinc-900"><b>hello</b></label>
        ...
        <div className="w-full lg:px-[680px] pb-[25px]">
          ...
          you can reach me on:<br/> <a href="tel:+27842368752">tel: 0842368752</a><br/><a href="mailto:ludmilpaulo@gmail.com">email: ludmilpaulo@gmail.com</a><br/><br/>
